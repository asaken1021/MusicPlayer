...
public class MusicLibrary {
    ...
    private static final HashMap<String, Uri> musicFileUrl = new HashMap<>();
    ...
    public static Uri getMusicUrl(String mediaId) {
        Uri uri = musicFileUrl.containsKey(mediaId) ? musicFileUrl.get(mediaId) : null;
        return uri;
    }
    ...
    public static void setMediaItems(List<SongMetaTag> tunes){
        int i = 0;
        for (SongMetaTag tune : tunes) {
    ...
    private static void createMediaMetadataCompat(
        ...
        musicFileUrl.put(mediaId, musicUrl);
    }
}